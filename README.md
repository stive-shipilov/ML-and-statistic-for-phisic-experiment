...
- Исследование различиных методов для разных случаев входных данных можно подробно прочитать в [докладе](https://github.com/stive-shipilov/Statistical-methods-research)
